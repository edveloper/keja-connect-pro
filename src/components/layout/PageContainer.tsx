...
import { LogOut, Menu, HelpCircle, ShieldAlert, MessageSquare } from "lucide-react";
          ...
          <div className="px-5 py-5 w-full max-w-lg flex justify-between items-start">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" size="icon" className="text-muted-foreground -mt-1 shrink-0 ml-2">
