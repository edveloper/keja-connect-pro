          ...
          <CardContent className="pt-6 space-y-4">
            <div className="flex items-center gap-4 p-2">
              ...
              <div className="flex-1">
                <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Call / WhatsApp</p>
            ...
            <div className="flex items-center gap-4 p-2">
              ...
              <div className="flex-1">
                <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Email Support</p>
                <a href={`mailto:${contactData.email}`} className="text-sm font-semibold hover:underline">
                  {contactData.email}
                </a>
              </div>
            </div>
            ...
            <div className="pt-4 border-t border-border/50 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <a href={contactData.website} target="_blank" className="text-xs text-primary font-medium hover:underline">
                  eddie-ezekiel.com
                </a>
              </div>
